...
export const patientIntakeSchema: FormSchema = {
  sections: [
    {
      section_id: 'personal',
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'select',
          required: false,
          options: ['he_him', 'she_her', 'they_them', 'other'],
        },
        {
        ...
        {
          field_id: 'emergency_contact_phone',
          label: 'Emergency Contact Phone',
          type: 'phone',
          required: true,
        },
        {
          field_id: 'emergency_contact_relationship',
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: 'Describe your main concern or symptoms',
          type: 'textarea',
          required: false,
          max_length: 1000,
          condition: {
            field_id: 'visit_reason',
            operator: 'in',
            value: ['specific_concern', 'ongoing_condition'],
          },
        },
        {
        ...
        {
          field_id: 'preferred_provider',
          label: 'Do you have a preferred provider at our practice?',
          type: 'text',
          required: false,
          max_length: 200,
        },
        {
          field_id: 'preferred_appointment',
    ...
    },
    {
      ...
      fields: [
        ...
        {
          field_id: 'conditions_other',
          label: 'Other conditions not listed',
          type: 'textarea',
          required: false,
          max_length: 500,
        },
    ...
    },
    {
      ...
      fields: [
        {
          field_id: 'family_history_unknown',
          label: 'Family medical history is unknown',
          type: 'boolean',
          required: false,
        },
        {
          field_id: 'family_conditions',
          label:
            'Do any immediate family members have the following conditions?',
          type: 'group',
          required: true,
          fields: [
            {
            ...
            },
            {
              ...
              required: false,
              max_length: 300,
              hint: 'e.g., "Father -- diagnosed at age 50, colon cancer"',
            },
          ],
        },
      ],
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'multi_select',
          required: false,
          options: ['cigarettes', 'cigars', 'pipe', 'chewing', 'vaping'],
          condition: {
            field_id: 'tobacco_use',
            operator: 'equals',
            value: 'current',
        ...
        {
          field_id: 'alcohol_use',
          label: 'Do you consume alcohol?',
          type: 'select',
          required: true,
          options: ['never', 'occasionally', 'moderately', 'heavily'],
        },
        {
          ...
          condition: {
            field_id: 'alcohol_use',
            operator: 'in',
            value: ['occasionally', 'moderately', 'heavily'],
          },
        },
        {
          field_id: 'recreational_drugs',
        ...
        },
        {
          ...
          label: 'If current or former, please describe',
          type: 'textarea',
          required: false,
          max_length: 500,
          condition: {
        ...
        {
          field_id: 'exercise_frequency',
          label: 'How often do you exercise?',
          type: 'select',
          required: true,
          options: ['none', '1_2_weekly', '3_4_weekly', '5_plus_weekly', 'daily'],
        },
        {
          field_id: 'diet_description',
    ...
    },
    {
      ...
      fields: [
        {
          field_id: 'consent_treatment',
          label: 'I consent to examination and treatment',
          type: 'boolean',
          required: true,
          hint: 'Must be accepted to proceed',
        },
        {
          field_id: 'consent_privacy',
          label: 'I acknowledge the privacy practices notice',
          type: 'boolean',
          required: true,
          hint: 'Must be accepted to proceed',
        },
        {
          field_id: 'consent_billing',
          label: 'I authorize billing to my insurance',
          type: 'boolean',
          required: false,
          condition: {
            field_id: 'has_insurance',
          ...
          hint: 'Required if you have insurance',
        },
        {
          field_id: 'signature_name',
          label: 'Typed Signature (Full Legal Name)',
          type: 'text',
          required: true,
          hint: 'Must match the full legal name provided above',
        },
        {
