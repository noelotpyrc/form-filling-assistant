...
export const mastersSchema: FormSchema = {
  sections: [
    {
      section_id: 'personal',
      ...
      fields: [
        {
          ...
          required: true,
          options: [
            { value: 'cs', label: 'Computer Science (MS)' },
            { value: 'data_science', label: 'Data Science (MS)' },
            { value: 'mba', label: 'Business Administration (MBA)' },
            { value: 'education', label: 'Education (MEd)' },
            { value: 'public_health', label: 'Public Health (MPH)' },
            { value: 'engineering', label: 'Mechanical Engineering (MS)' },
          ],
        },
        {
          field_id: 'start_term',
        ...
        },
        {
          ...
          label: 'Have you previously applied to Northfield?',
          type: 'boolean',
          required: true,
        },
        {
          field_id: 'prior_application_year',
    ...
    {
      section_id: 'test_scores',
      title: 'Standardized Test Scores',
      fields: [
        {
          field_id: 'gre_taken',
          label: 'Have you taken the GRE?',
          type: 'boolean',
          required: false,
          condition: {
            field_id: 'program',
        ...
        },
        {
          ...
          label: 'GRE Analytical Writing Score',
          type: 'number',
          required: false,
          min: 0,
          max: 6,
        ...
        {
          field_id: 'toefl_required',
          label: 'Is TOEFL/IELTS required?',
          type: 'boolean',
          required: false,
          hint: 'Auto-determined based on country of citizenship',
          condition: {
            field_id: 'country_citizenship',
            operator: 'not_in',
            value: ['US', 'CA', 'UK', 'AU', 'NZ'],
          },
        },
        {
          field_id: 'english_test_type',
    ...
    },
    {
      ...
      fields: [
        ...
        {
          field_id: 'additional_docs',
          label: 'Additional Supporting Documents',
          type: 'file',
          required: false,
          accepted_types: ['pdf', 'docx', 'jpg', 'png'],
          max_size_mb: 10,
          max_files: 3,
        },
      ],
      ...
      fields: [
        {
          ...
          label: 'Interested in funding/assistantships?',
          type: 'boolean',
          required: true,
        },
        {
        ...
        {
          field_id: 'disability_accommodation',
          label: 'Do you require disability accommodations?',
          type: 'boolean',
          required: false,
        },
        {
          field_id: 'how_heard',
          label: 'How did you hear about Northfield?',
          type: 'select',
          required: false,
          options: [
